...
const BRAND_SYMBOL = Symbol.for('fractils-signals')
...
function signal<T>(value: T): Signal<T> {
	return new Signal(value) as Signal<T>
}
...
export { signal, computed, effect, batch, untracked, Signal, type ReadonlySignal }
