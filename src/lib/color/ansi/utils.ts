 ...
 * For example, "#112233".
 *
 * @param value A string that contains the hexadecimal RGB color representation.
 * @returns The red, green, blue values in range [0, 255].
 */
 ...
 *
 * Original source: https://github.com/Qix-/color-convert/blob/master/conversions.js#L551
 */
